...
Compile_Clang_MP : 3D_LifeGame.cpp
	clang++ 3D_LifeGame.cpp OpenCL.cpp -o 3D_LifeGame -O3 -lGL -lGLU -lglut -fopenmp -DUSE_OPENMP -DOPENMP_THREAD=4
...
Compile_Gnugcc_MP : 3D_LifeGame.cpp
	g++ 3D_LifeGame.cpp OpenCL.cpp -o 3D_LifeGame -O3 -lGL -lGLU -lglut -fopenmp -DUSE_OPENMP -DOPENMP_THREAD=4
